...
namespace AD_BS_Converter
{
    ...
    {
        public string Add_days_to_BS_Date(string BaseDateBS, int days2add, int No_of_Month_in_List, string[] days_of_each_Month_in_List)
        {
            string newDate = "";
        ...
        public string NewDateAFterAddingDays_and_Months(int DaysToAdd, int MonthsToAdd, string OldDate)
        {
            try
            {
        ...
        public int DifferenceInDate(string StartDate, string EndDate)
        {
            try
            {
                //Date should be in format YYYY-MM-DD e.g. 2022-02-23
